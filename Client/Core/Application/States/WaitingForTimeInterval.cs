...
{
    public class WaitingForTimeInterval : IState
    {
        private readonly IUserManageService _userManageService;

        public WaitingForTimeInterval(IUserManageService userManageService)
        {
        ...
        public async Task<Response<OutputMessage>> Handle(IUserContext context, Message message, CancellationToken cancellationToken = default)
        {
            ...
            return await new EnableWarningsAction(_userManageService).Do(message, cancellationToken);
        }
    }
}
